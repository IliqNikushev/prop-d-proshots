...
namespace Design.Idea
{
    public partial class Store : Form
    {
        ...
        public Store()
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                items.Add(new ShopItem(new Classes.ShopItem(0, r.Next(5000) / 1000m, "", "Back","<>","","","", i+1, (i+1)/2, null, 0)));
            }
            ...
            ShopItem example = new ShopItem(new Classes.ShopItem(0, 0, "", "Back","<>","","","", 0, 0, null, 0));
