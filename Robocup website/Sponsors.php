...
<header class="intro-header" style="background-image: url('img/home.jpg'); background-repeat: no-repeat; background-size: 100% 100%;" id="background-image" ></header>
    ...
    <div id="Elements-Placement">
			...
			The combination of fascinating robotics, vivacious competitions and presentations from innovative organizations that want to contribute to high tech solutions for a better society make RoboCup 2015 into an ideal stage and meeting place for:<br><br>
