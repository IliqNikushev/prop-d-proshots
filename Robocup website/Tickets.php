...
<header class="intro-header" style="background-image: url('img/home.jpg'); background-repeat: no-repeat; background-size: 100% 100%;" id="background-image" ></header>
    ...
    <div id="Elements-Placement">
			...
			<input type="submit" name="Payment" value="Add additional visitor"><br><br>
		<select name="sometext" size="5" id="TextBox">
		<option>Visitor1</option>
		<option>Visitor2</option>
		<option>Visitor3</option>
		</select>
