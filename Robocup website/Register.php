        ...
        if ($_POST['Register'])
{
    ...
    if (isset($_POST['username']) && isset($_POST['password'])){
        ...
        $query1 = mysql_query("SELECT username FROM User WHERE username='$username'");
        $query2 = mysql_query("SELECT email FROM User WHERE email='$email'");

  if (mysql_num_rows($query1) || mysql_num_rows($query2) != 0)
  {
	...
	if(isset($msg) & !empty($msg)){
        ...
        ?>
			...
			<div style="display: inline-block; width:16%"><b>Username: </b></div>
                        <input required="1" pattern=".{3,20}" required title="from 3 to 20 characters" type="text" name="username" placeholder="Username"><br><br>
			...
			<div style="display: inline-block; width:16%"><b>Password: </b></div>
                        <input required="1" pattern=".{4,20}" required title="from 4 to 20 characters" type="password" name="password" placeholder="Password"><br><br>
			
			<div style="display: inline-block; width:16%"><b>Confirm Password: </b></div>
                        <input required="1" onChange="checkPasswordMatch();" type="password" name="Cpassword" placeholder="Confirm Password"><br><br>
                        
			<div style="display: inline-block; width:16%"><b>Email: </b></div>
			<input required="1" pattern=".{6,20}" required title="from 6 to 20 characters" type="email" name="email" placeholder="Email"><br><br>
